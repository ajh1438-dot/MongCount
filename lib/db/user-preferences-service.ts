...
export const DEFAULT_SLOT_CONFIGS: readonly NotificationSlotConfig[] = [
  { id: "default-0", time: "08:30", label: "5분 숨 고르고..." },
  { id: "default-1", time: "10:30", label: "한 번 멈춰서..." },
  { id: "default-2", time: "13:00", label: "점심 후..." },
  { id: "default-3", time: "15:30", label: "오후 경향..." },
  { id: "default-4", time: "19:00", label: "일의 끝..." },
  { id: "default-5", time: "22:00", label: "오늘 하루..." },
];
